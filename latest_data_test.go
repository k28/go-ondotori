...
func TestLatestData(t *testing.T) {
	js, err := ioutil.ReadFile("./latest_data.json")
	if err != nil {
...
func testLatestData(t *testing.T, ld *LatestData) {
...
func testChannel(t *testing.T, ld *LatestData) {
	var ch = ld.Channel[0]
...
func testData(t *testing.T, ld *LatestData) {
	var data = ld.Data[0]
